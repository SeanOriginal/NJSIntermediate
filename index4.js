...
function camelCase(cssProp) {
  ...
  console.log("For _ loop function: ", camelCase("margin-left"));
  console.log("For _ of loop function: ", camelCase("background-image"));
  console.log("For _ of loop function: ", camelCase("display"));
  
  //loop without conditional operator
  function camelCase(cssProp) {
    let result = "";
  ...
  console.log(
    "For loop without conditional operator function: ",
